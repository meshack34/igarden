...
<v-app id="home"
  :style="{ background: $vuetify.theme.themes.dark.background }">
    ...
    <v-container fluid>
      <v-row>
        <v-col cols="6">
          <v-img src="campus.jpeg" contain max-height="500"></v-img>
        </v-col>
        <v-col cols="6">
          <h5 class="red--text text--darken-4 top">Hel</h5>
          ...
          <v-btn tile color="#A7121D" dark @click="contract = true"> Apply now </v-btn>
